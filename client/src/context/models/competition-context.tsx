...
type Form = CompetitionForm;
type Get = CompetitionGet;
type Model = Competition;
...
const useCompetition = () => {
  const single = useContext(CompetitionContext.single);
  const bulk = useContext(CompetitionContext.bulk);

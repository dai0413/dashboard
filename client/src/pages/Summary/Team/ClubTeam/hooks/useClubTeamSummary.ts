...
export const useClubTeamSummary = (id: string): UseClubTeamSummary => {
  ...
  return {
    ...
    future_in: {
      ...
      items: futurein.data,
      reloadFun: async () => readFutureins(id, seasonDates.future.seasonRange),
    },
    ...
    playerRegistration: {
      ...
      reloadFun: async () =>
        readPlayerRegistrations(id, selectedteamCompetitionSeason?.season._id),
    },
    ...
    piePlot: {
      ...
      reloadFun: async () =>
        readRadarData(selected, id, selectedteamCompetitionSeason?.season._id),
    },
  };
};

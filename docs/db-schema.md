...
- [データベース設計](#データベース設計)
  ...
  - [30. 審判の出場履歴(Referee-Appearance)](#30-審判の出場履歴referee-appearance)
    - [フィールド一覧](#フィールド一覧-28)
    - [組み合わせ (Mongoose)](#組み合わせ-mongoose-27)
    - [バリデーション(zod)](#バリデーションzod-11)
    - [備考](#備考-5)
  - [今後](#今後)
  - [. 出場停止](#-出場停止)
  - [. 監督キャリア](#-監督キャリア)
...
| ------------ | ----------------- | ------------ | ------- | ------- |
| match        | 外部キー          | 試合 (Match) | true    |         |
| referee      | 外部キー(Referee) | 審判         |         |         |
| referee_name | 文字列            | 審判名       |         |         |
| role         | 文字列            | 役割         |         |         |
...
- **referee または referee_name どちらかを入力**

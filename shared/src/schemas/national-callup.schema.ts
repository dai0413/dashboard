...
export const NationalCallUpZodSchema = NationalCallUpBaseZodSchema.refine(
...
export const NationalCallUpResponseSchema = NationalCallUpBaseZodSchema.omit({
  series: true,
  player: true,
  team: true,
  team_name: true,
...
export const NationalCallUpPopulatedSchema = NationalCallUpBaseZodSchema.omit({
  series: true,
  player: true,
  team: true,
}).safeExtend({

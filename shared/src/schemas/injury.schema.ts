...
export const InjuryBaseZodSchema = z.object({
  _id: objectId,
...
export const InjuryZodSchema = InjuryBaseZodSchema.refine(
...
export const InjuryResponseSchema = InjuryBaseZodSchema.omit({
  team_name: true,
}).extend({
...
export const InjuryPopulatedSchema = InjuryBaseZodSchema.omit({
  team: true,
  now_team: true,
  player: true,
}).safeExtend({

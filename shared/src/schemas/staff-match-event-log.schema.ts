...
export const StaffMatchEventLogBaseZodSchema = z.object({
  _id: objectId,
...
export const StaffMatchEventLogZodSchema =
  StaffMatchEventLogBaseZodSchema.refine(
    (d) => {
...
export const StaffMatchEventLogPopulateLabelSchema =
  StaffMatchEventLogBaseZodSchema.omit({
    match: true,
    team: true,
    match_event_type: true,

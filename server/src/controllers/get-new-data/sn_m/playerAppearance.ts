...
import { getPlayerAppearance as get } from "@dai0413/scraping-logic/SN";
import BadRequestError from "../../../errors/bad-request.js";
import InternalServerError from "../../../errors/internal-server.js";

const getPlayerAppearance = async (
  req: Request,
  res: Response<CreateItemResponse<Scraped[any]["playerAppearance"]>>,
) => {
  try {
    const { url } = req.body;
    ...
    throw new InternalServerError("Failed to fetch playerAppearance");
  }
};

import { season } from "@dai0413/myorg-shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { SeasonModel } from "../../models/season.js";

const getAllItems = crudFactory(season(SeasonModel)).getAllItems;
const createItem = crudFactory(season(SeasonModel)).createItem;
const getItem = crudFactory(season(SeasonModel)).getItem;
const updateItem = crudFactory(season(SeasonModel)).updateItem;
const deleteItem = crudFactory(season(SeasonModel)).deleteItem;

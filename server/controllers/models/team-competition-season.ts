...
// const createItem = crudFactory(teamCompetitionSeason).createItem;
// const getItem = crudFactory(teamCompetitionSeason).getItem;
// const updateItem = crudFactory(teamCompetitionSeason).updateItem;
// const deleteItem = crudFactory(teamCompetitionSeason).deleteItem;

...
const createItem = crudFactory(competitionStage).createItem;
const getItem = crudFactory(competitionStage).getItem;
const updateItem = crudFactory(competitionStage).updateItem;
const deleteItem = crudFactory(competitionStage).deleteItem;

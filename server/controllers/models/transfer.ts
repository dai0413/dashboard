...
const createItem = crudFactory(transfer).createItem;
const getItem = crudFactory(transfer).getItem;
const updateItem = crudFactory(transfer).updateItem;
const deleteItem = crudFactory(transfer).deleteItem;

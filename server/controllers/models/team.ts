...
import { team } from "@myorg/shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { TeamModel } from "../../models/team.js";

const getAllItems = crudFactory(team(TeamModel)).getAllItems;
const createItem = crudFactory(team(TeamModel)).createItem;
const getItem = crudFactory(team(TeamModel)).getItem;
const updateItem = crudFactory(team(TeamModel)).updateItem;
const deleteItem = crudFactory(team(TeamModel)).deleteItem;

const { MONGO_MODEL } = team(TeamModel);

...
// const createItem = crudFactory(referee).createItem;
// const getItem = crudFactory(referee).getItem;
// const updateItem = crudFactory(referee).updateItem;
// const deleteItem = crudFactory(referee).deleteItem;

import { stadium } from "@myorg/shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { StadiumModel } from "../../models/stadium.js";

const getAllItems = crudFactory(stadium(StadiumModel)).getAllItems;
const createItem = crudFactory(stadium(StadiumModel)).createItem;
const getItem = crudFactory(stadium(StadiumModel)).getItem;
const updateItem = crudFactory(stadium(StadiumModel)).updateItem;
const deleteItem = crudFactory(stadium(StadiumModel)).deleteItem;

...
// const getAllItems = crudFactory(nationalMatchSeries).getAllItems;
// const createItem = crudFactory(nationalMatchSeries).createItem;
// const getItem = crudFactory(nationalMatchSeries).getItem;
// const updateItem = crudFactory(nationalMatchSeries).updateItem;
// const deleteItem = crudFactory(nationalMatchSeries).deleteItem;

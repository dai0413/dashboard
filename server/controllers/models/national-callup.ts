import { nationalCallUp } from "@dai0413/myorg-shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { NationalCallUpModel } from "../../models/national-callup.js";

const getAllItems = crudFactory(
  nationalCallUp(NationalCallUpModel)
).getAllItems;
const createItem = crudFactory(nationalCallUp(NationalCallUpModel)).createItem;
const getItem = crudFactory(nationalCallUp(NationalCallUpModel)).getItem;
const updateItem = crudFactory(nationalCallUp(NationalCallUpModel)).updateItem;
const deleteItem = crudFactory(nationalCallUp(NationalCallUpModel)).deleteItem;

import { competition } from "@dai0413/myorg-shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { CompetitionModel } from "../../models/competition.js";

const getAllItems = crudFactory(competition(CompetitionModel)).getAllItems;
const createItem = crudFactory(competition(CompetitionModel)).createItem;
const getItem = crudFactory(competition(CompetitionModel)).getItem;
const updateItem = crudFactory(competition(CompetitionModel)).updateItem;
const deleteItem = crudFactory(competition(CompetitionModel)).deleteItem;

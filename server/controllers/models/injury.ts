import { injury } from "@myorg/shared";
import { crudFactory } from "../../utils/crudFactory.js";
import { InjuryModel } from "../../models/injury.js";

const getAllItems = crudFactory(injury(InjuryModel)).getAllItems;
const createItem = crudFactory(injury(InjuryModel)).createItem;
const getItem = crudFactory(injury(InjuryModel)).getItem;
const updateItem = crudFactory(injury(InjuryModel)).updateItem;
const deleteItem = crudFactory(injury(InjuryModel)).deleteItem;
